...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Java()
{
	...
	if (!inited)
	{
		static const char* const javaKeywords[] = {
			"abstract", "assert", "boolean", "break", "byte", "case", "catch", "char", "class", "continue", "default", "do", "double", "else", "enum", "extends", "final", "finally", "float",
			"for", "if", "implements", "import", "instanceof", "int", "interface", "long", "native", "new", "null", "package", "private", "protected", "public", "return", "short", "module",
			"static", "strictfp", "super", "switch", "synchronized", "this", "throw", "throws", "transient", "try", "void", "volatile", "while", "requires", "record", "var", "volatile",
			"String", "List", "Collectors", "Optional", "Boolean", "Integer", "Short", "Long", "Double", "Float", "ArrayList", "Map", "Math", "Character", "HashMap", "Object"
		};
		for (auto& k : javaKeywords)
			langDef.mKeywords.insert(k);

		static const char* const identifiers[] = {
			"abs", "acos", "asin", "atan", "atexit", "atof", "atoi", "atol", "ceil", "clock", "cosh", "fabs", "floor", "log10", "log2", "log", "memcmp", "modf", "pow", "get", "toString",
			"equals", "sqrt", "put"
		};
		for (auto& k : identifiers)
		{
